...
public class SettingsModel implements Serializable {
    ...
    private String smsGateway1api;
    private String smsGateway2api;
    ...
    public void setAppointmentTemplate(String appointmentTemplate) {
        this.appointmentTemplate = appointmentTemplate;
    }

    public String getSmsGateway1api() {
        return smsGateway1api;
    }

    public void setSmsGateway1api(String smsGateway1api) {
        this.smsGateway1api = smsGateway1api;
    }

    public String getSmsGateway2api() {
        return smsGateway2api;
    }

    public void setSmsGateway2api(String smsGateway2api) {
        this.smsGateway2api = smsGateway2api;
    }
