        ...
        /* CommonImplements commonController1 = (CommonImplements) RegistryFactory.getClientStub(RegistryConstants.CommonImplements);
            commonController1.gstModel();
             ...
             int gst=CommonDAO.gst;
              if(gst==0)
               {*/
                   drugViewTable.getColumnModel().getColumn(6).setMinWidth(0);
                   drugViewTable.getColumnModel().getColumn(6).setMaxWidth(0);
         /*      }
             if(sgst==0)
               {
                   drugViewTable.getColumnModel().getColumn(7).setMinWidth(0);
                   drugViewTable.getColumnModel().getColumn(7).setMaxWidth(0);
               }

             if(cgst==0)
               {
                   drugViewTable.getColumnModel().getColumn(8).setMinWidth(0);
                   drugViewTable.getColumnModel().getColumn(8).setMaxWidth(0);
               }

             if(igst==0)
               {
                  drugViewTable.getColumnModel().getColumn(9).setMinWidth(0);
                  drugViewTable.getColumnModel().getColumn(9).setMaxWidth(0);
               }

             if(utgst==0)
               {*/
                  drugViewTable.getColumnModel().getColumn(10).setMinWidth(0);
                  drugViewTable.getColumnModel().getColumn(10).setMaxWidth(0);
           //    } 
...
//@kural
        drugViewTable.removeColumn(drugViewTable.getColumnModel().getColumn(3));
...
/////////////////////////////////////////////////////////////////////
 ...
 //@kural
                drugViewTable.getModel().setValueAt(drugBean.getGst(), i, 6);
                drugViewTable.getModel().setValueAt(drugBean.getSgst(), i, 7);
                drugViewTable.getModel().setValueAt(drugBean.getCgst(), i, 8);
                drugViewTable.getModel().setValueAt(drugBean.getIgst(), i, 9);
              //  drugViewTable.getModel().setValueAt(drugBean.getUtgst(), i, 10);
...
//            }
    ...
    public String searchDrugInformationValues(String name, Integer type,Integer start, Integer limit) {
        clearData();
        String valu = "No Products Found";
        int jk = 0;
        drugSetId = "-1";
        try {
           ...
           // Drug dc;// = new DrugController();
            ...
            if (type == 0) {
                ...
                drugBean.setDrug_name(name);
                //dc = new DrugController();
                drugList = drugController.viewRecordByLimit(drugBean, start, limit);
