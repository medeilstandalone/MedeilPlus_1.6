...
public class MedicalHistoryTable extends javax.swing.JDialog {
    ...
    public   List<MedicalHistoryModel1> settablevalues12(Object medicalHistroyModel){
        ...
        model=(MedicalHistoryModel1)medicalHistroyModel;
    ...
    public List<MedicalHistoryModel1> getTableValues() {
        int rowCount = jcomp.getModel().getRowCount();
        List<MedicalHistoryModel1> values = new ArrayList<MedicalHistoryModel1>();
        MedicalHistoryModel1 model;
        try {
            for (int i = 0; i < rowCount; i++) {
                    model = new MedicalHistoryModel1();
