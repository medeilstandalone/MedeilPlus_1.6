...
public class Diagnosticdoctors {
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            product2.promptText = "Search  Diagnostic Name";
                            ...
                            txtDiagtype.promptText = "Search  Diagnostic Type";
  ...
  public function StartUp(): Void
         {
            ...
            // HomePage.Hide();
            // txtSalesCaPName.requestFocus();
            //panel.content = [ product_rectangle2, product_code, lblDiagnostictype, product2, txtDiagtype, batch2, productimageView6, imgDiagtype, PolicyNo, InsurName, label19, label22, quantity, batch, qutinhand, rdoinsureYes, rdoinsureNo  ];
            panel.content = [ product_rectangle2, product_code, lblDiagnostictype, product2, txtDiagtype, batch2, productimageView6, imgDiagtype,PolicyNo, InsurName, label19, label22, quantity, batch, qutinhand, rdoinsureYes, rdoinsureNo,label2,txtSalesCaPName,imgPName,txtSalesCaDName,label9,label8,txtSalesCaDate,imgDName,CashDatePicker,btnSaveOnly,imageView2,btnSalesCaSave,imageView,btnSalesCaReset,imageView3,rectRemoveRow,LabelRemoveRow ];
             initSalesCash();
             txtSalesCaPName.requestFocus();
            // product2.requestFocus();
