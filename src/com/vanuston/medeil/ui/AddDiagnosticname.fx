...
public class AddDiagnosticname {

    var log: Logger = Logger.getLogger(AddDiagnosticname.class, "Utilities");
    ...
    function FXinfo(msg: String): Void {
        CustomAlert.ShowInfo("Add Diagnostic Name", msg);
        showAlertbox();
    }
         ...
         if(ms==null and ms==""){
              ...
              //var commonController:CommonImplements = new CommonController();
               var commonController: CommonImplements=RegistryFactory.getClientStub(RegistryConstants.CommonImplements) as CommonImplements;
                ...
                var a= commonController.getAddService1(ms);
                 if (a == 1) {
            ...
            var msg: String = "Class : AddDiagnosticname  Method : saveformulation()   = {e.getMessage()}";
            log.debug(msg);
        }
    }
