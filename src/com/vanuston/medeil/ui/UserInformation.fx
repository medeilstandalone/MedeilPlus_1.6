...
public class UserInformation {
    ...
    def __layoutInfo_choicebox62: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind PrivilageW
    }
    public-read def choicebox62: javafx.scene.control.ChoiceBox = javafx.scene.control.ChoiceBox {
        visible: false
        layoutX: bind PrivilageC4LX
        layoutInfo: __layoutInfo_choicebox62
        items: bind privillages
    }
    ...
    def __layoutInfo_lblModule11: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind PrivilageW
    }
    public-read def lblModule11: javafx.scene.control.Label = javafx.scene.control.Label {
        layoutX: bind PrivilageC1LX
        layoutY: 430.0
        layoutInfo: __layoutInfo_lblModule11
        text: "Label"
        font: Arial_12
        textFill: DarkGray
    }
      ...
      userController = RegistryFactory.getClientStub(RegistryConstants.UserInformation) as com.vanuston.medeil.implementation.UserInformation;
        if (setEditionPrivlgs()) {
            if (sales == 1) {
                ...
                choicebox11.disable = userController.getFormStatus(0, "appointment"); // Cash Bill       // Controller Call
...
//                choicebox31.disable = userController.getFormStatus(2, "sales"); // Dummy Bill   // Controller Call
//                choicebox12.disable = userController.getFormStatus(3, "sales"); // Sales Return   // Controller Call
//                choicebox22.disable = userController.getFormStatus(4, "sales"); // Sales Maintenance  // Controller Call
            } else if (inventory == 1) {
                disCombo();
...
//                choicebox52.disable = userController.getFormStatus(9, "finance"); // "VAT_Summary" // Controller Call
                ...
                choicebox31.disable = userController.getFormStatus(2, "crm"); //  Complaint Register  // Controller Call
                choicebox12.disable = userController.getFormStatus(3, "crm");
                choicebox22.disable = userController.getFormStatus(4, "crm");
                choicebox32.disable = userController.getFormStatus(5, "crm");
            } else if (reports == 1) {
...
//        panelModule3.visible = true;
        ...
        lblModule1.text = "Add Appointment";
        lblModule3.text = "Manage Apppointment";
...
//        choicebox12.select(s4);
    ...
    public function InvShow(): Void {
        ...
        lblModule1.text = "Practice Management";
        lblModule3.visible = false;
        lblModule2.visible = false;
        lblModule5.visible = false;
        lblModule7.visible = false;
        lblModule4.visible = false;
        lblModule6.visible = false;
        choicebox12.visible = false ;
        choicebox22.visible = false;
        choicebox31.visible = false;
        choicebox32.visible = false;
        choicebox41.visible = false;
        choicebox42.visible = false;
        choicebox11.select(inv1);
        choicebox21.visible = false;
    ...
    public function MasterShow(): Void {
        ...
        lblModule3.text = "Doctor Information";
        lblModule5.text = "Patient Information";
    ...
    public function FinancialShow(): Void {
        ...
        lblModule5.text = "Sales Return";
        lblModule7.text = "Sales Maintenance";
        lblModule2.text = "Purchase Order";
        lblModule4.text = "Purchase Invoice";
        lblModule6.text = "Purchase Return";
        lblModule8.text = "Stock";
        lblModule9.visible = false;
        lblModule10.visible = false;
        choicebox51.visible = false;
        choicebox52.visible = false;
        choicebox61.visible = false;
        choicebox62.visible = false;
        choicebox71.visible = false;
        choicebox72.visible = false;
        choicebox11.select(f1);
        choicebox21.select(f2);
        choicebox31.select(f3);
        choicebox41.select(f4);
        choicebox12.select(f5);
        choicebox22.select(f6);
        choicebox32.select(f7);
        choicebox42.select(f8);
        panelModule6.visible = false;
...
//        choicebox52.select(f10);
    ...
    public function CRMShow(): Void {
        ...
        lblModule2.text = "Debit Note";
        lblModule4.text = "Daily Cash Book";
        lblModule6.text = "VAT Summary";
        lblModule12.visible = false;
        lblModule7.visible = false;
        lblModule8.visible = false;
        lblModule9.visible = false;
        lblModule10.visible = false;
        ...
        choicebox31.select(crm3);
        choicebox12.select(crm4);
        choicebox22.select(crm5);
        choicebox32.select(crm6);
   }
    ...
    public function ReportShow(): Void {
        ...
        panelModule3.visible = true;
        panelModule4.visible = true;
        lblModule1.text = "Appointment";
        lblModule3.text = "Practice Mgt";
        lblModule5.text = "Sales";
        lblModule7.text = "Purchase";
        lblModule2.text = "Product";
        lblModule4.text = "Stock & Analysis";
        lblModule6.text = "Masters";
        lblModule8.text = "Finance & CRM";
...
//        pwdCurrPass.layoutY   = 158.0;lblCurrPass.layoutY=158.0;
    ...
    function fetchUserDet(getName: String): Void {
        try {
            ...
            radUser.disable = false;
            radUserAdmin.disable = false;
            rdoUserRemove.disable = false;
            btnEmp1.disable = false ;
            userType = userInformationModel.getUserType();
            if (userInformationModel.getUserType().equals("User")) {
                radUser.selected = true;
            } else if (userInformationModel.getUserType().equals("Admin")) {
                radUserAdmin.selected = true;
            } else if(userInformationModel.getUserType().equals("SuperAdmin")){
                onSelAdmin();
                if(btnEmp1.text.equals("Delete [F6]")) {
                    btnEmp1.disable = true ;
                } else {
                    btnEmp1.disable = false ;
                }
                radUser.selected = false;
                radUserAdmin.selected = false;
                radUserAdmin.selected = true;
                radUser.disable = true;
                radUserAdmin.disable = true;
                rdoUserRemove.disable = true;
            }
...
//            f9 = Integer.parseInt(f[8]); f10 = Integer.parseInt(f[9]);
            ...
            crm3 = Integer.parseInt(crm[2]); crm4 = Integer.parseInt(crm[3]);
            crm5 = Integer.parseInt(crm[4]); crm6 = Integer.parseInt(crm[5]);
    ...
    function setEditionPrivlgs(): Boolean {
        ...
        if (comObj.getProductType().equals("Lite")) {
            //s2= 0; s3 = 0; s4 =0; s6 = 0;
    ...
    function isAdminCheck(): Void {
        try {
            if (radUserAdmin.selected) {
                ...
                crm1 = 3; crm2 = 3; crm3 = 3;crm4 = 3;crm5 = 3;crm6 = 3;
            ...
            log.debug("Method:isAdminCheck msg = {e.getMessage()}");
        }
    }
                ...
                if (txtEmpUName.rawText != null and pwdEmpPass.rawText != null and pwdEmpConfirm.rawText != null) {
                    if (checkAvailability()) {
                        if (checkPassword(pwdEmpPass.rawText, pwdEmpConfirm.rawText)) {
                            if (utype != null) {
                                userInfoModel.setAppointment("{a1},{a2}");
                                userInfoModel.setPracticemanage("{p1},{p2}");
                                userInfoModel.setHome("{h1},{h2},{h3}");
                                userInfoModel.setInventory("{inv1},{inv2}");
                                userInfoModel.setSales("{s1},{s2}");
                                userInfoModel.setFinance("{f1},{f2},{f3},{f4},{f5},{f6},{f7},{f8}");
                                userInfoModel.setReports("{r1},{r2},{r3},{r4},{r5},{r6},{r7},{r8}");
                                userInfoModel.setCRM("{crm1},{crm2},{crm3},{crm4},{crm5},{crm6}");
                                userInfoModel.setMasters("{m1},{m2},{m3},{m4},{m5}");
...
//            s5 = choicebox22.selectedIndex;
        ...
        if (financial == 1) {
            ...
            f5 = choicebox12.selectedIndex;
            f6 = choicebox22.selectedIndex;
            f7 = choicebox32.selectedIndex;
            f8 = choicebox42.selectedIndex;
...
//            f10 = choicebox52.selectedIndex;
        ...
        if (crm == 1) {
            ...
            crm3 = choicebox31.selectedIndex;
            crm4 = choicebox12.selectedIndex;
            crm5 = choicebox22.selectedIndex;
            crm6 = choicebox32.selectedIndex;
        }
        if (reports == 1) {
