...
public class SubMenuEhr {
    ...
    def PrescriptionFormat = LabModule {};
    def Diagnosticdoctor = Diagnosticdoctor {};
    def SalesCash1 = SalesCash13 {};
    ...
    public-read def group3: javafx.scene.Group = javafx.scene.Group {
        ...
        layoutY: bind rectMenuY[1]+50
        content: [ rectangle, lblMenu3, imgMenu3, ]
    }
    ...
    public-read def panelInventorySubMenu: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        ...
        layoutX: 0.0
        layoutY: 0.0
        content: [ group1, group3, group2, panelInvForm, imgClose, ]
    }
    ...
    public-read def image8: javafx.scene.image.Image = javafx.scene.image.Image {
        url: "{__DIR__}images/cust123.png"
    }
    ...
    function rectangleOnMouseClickedAtSubMenu(event: javafx.scene.input.MouseEvent): Void {
      //  java.lang.System.out.println("chedck kijkjbj");
         showPrescrption1();
         }
   ...
   function group2OnMouseClickedAtSubMenu(event: javafx.scene.input.MouseEvent): Void {
    ...
    function rectMenu1OnMouseClickedAtSubMenu(event: javafx.scene.input.MouseEvent): Void {
      showlab();
        ...
        public function showPrescrption1() : Void {
           //nazia java.lang.System.out.println("inside showPrescrption1");
         if(DisableInv[1]){
            Msgbox();
        }else{
           //banu java.lang.System.out.println("inside showPrescrption1 else");
            deleteForm(2);
            //Diagnosticdoctor.MainPanel.disable = false;
            insert SalesCash1.getDesignRootNodes() into panelInvForm.content;
            SalesCash1.StartUp();
        } 
      /*  if (commonController.getProductType().equals("Free")) {
            editionAlert();
        } else if(DisableSales[5]){
...
//saba            HomePage.hide();
      ...
      public function showCustomer() : Void {
       ...
       public function showlab() : Void {
       //java.lang.System.out.println("Inside showCustomer");
       deleteForm(2);
       def LabModule=LabModule{};
       insert LabModule.getDesignRootNodes() into panelInvForm.content;
       LabModule.StartUp();
       }
    ...
    function getPrivillages(uname: String): String[] {
        ...
        if (not GetUserInfo.checkName(uname)) {
            var access: String = commonController.getPrivileges("ehr", uname);
            priv = access.split(",");
        }
        return priv;
    }
