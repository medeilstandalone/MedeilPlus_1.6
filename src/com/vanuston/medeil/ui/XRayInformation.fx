                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lbl2AddNew.text = "Add New  X - Ray  Files";
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lbl2AddNew.visible = true;
                            lbl2AddNew.layoutY = 65.0;
                            lbl2AddNew.text = "View All X - Ray ";
                            lbl2AddNew.font = Arial_18;
                            separator1.visible = true;
                            separator1.layoutX = 30.0;
                            separator1.layoutY = 90.0;
                            ...
                            btnPatientReport.font = Arial_Bold_12;
...
//                "-fx-background-color: white ;"
    ...
    function FXalert(type: Integer): Void {
        CustomAlert.ShowAlert("X - Ray Information", type);
        showAlertbox();
    }
    ...
    function FXinfo(msg: String): Void {
        CustomAlert.ShowInfo("X - Ray Information", msg);
        showAlertbox();
    }
    ...
    function txtPatientNameOnKeyReleased(event: javafx.scene.input.KeyEvent): Void {
        ...
        if (checkEditReguest) {
            radioViewTable.searchDicomInfoForEdit(txtPatientName.rawText.trim(), 1);
    ...
    public function getPatientOrDoctorList(): Void {
        ...
        radioViewTable.searchDicomInfo(txtPatientName.rawText.trim(), 1);

    }

    public function getPatientOrDoctorListForView(): Void {

        viewAllFileTable.searchDicomInfoForView(txtPatientName.rawText.trim(), 1);
    ...
    function onActionForGenerateReport(): Void {
        ...
        try {
            ...
            if (viewAllFileTable.dicomSetId != -1) {
                ...
                var reportSource: File = new File("printerfiles/X-rayreport.jasper");
                ...
                try {
                    ...
                    FXinfo("The Xray report has been printed sucessfully");
                } catch (ex: PrinterException) {
                    FXinfo("The Xray report has been not printed sucessfully");
                    var que: String = "Class : XRayInformation  Method : onActionForGenerateReport()   = {ex.getMessage()}";
                    log.debug(que);
                    ex.printStackTrace();
                }
            } else {
    ...
    function getFullDetails(): Void {
        ...
        try {
            ...
            var que: String = "Class : XRayInformation  Method : getFullDetails()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function selectItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : XRayInformation  Method : selectItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function edit(): Void {
        ...
        try {
            ...
            var que: String = "Class : XRayInformation  Method : edit()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function setTableLay(): Void {
        ...
        radioViewTable.loadRadioInformatio(1);
        txtPatientName.requestFocus();
    ...
    public function displayItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : XRayInformation  Method : displayItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function select(): Void {
        ...
        try {
            ...
            var que: String = "Class : XRayInformation  Method : select()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function reportGenerate(): Void {
        ...
        try {
            ...
            var que: String = "Class : XRayInformation  Method : reportGenerate()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayReport(num: Integer): Void {
        try {
            ...
            var sqlDates: Date = getTodayDate();
            var viewDcmFile = new ViewDicomFiles();
            viewDcmFile.openReportDialogBox(dcmModel, 1, sqlDates);
            System.out.println("Success");
        } catch (ex: Exception) {
            var que: String = "Class : XRayInformation  Method : displayReport()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayItemForView(num: Integer): Void {
        try {
            ...
            var que: String = "Class : XRayInformation  Method : displayItemForView()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
...
//    }
    public function cancel(): Void {
        try {
            ...
            var que: String = "Class : XRayInformation  Method : cancel()   = {ex.getMessage()}";
            log.debug(que);
        }
    }
