...
public class PatientDetails  {
    ...
    public-read def Date_Of: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C4LX
        text: "Label"
    }
    
    public-read def lbladvanceamount: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C1LX
        text: "Label"
    }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lblPatientDetails.text = "Patient Details - Alt+C";
                            ...
                            Date_Of.visible = false;
                            Date_Of.layoutY = 0.0;
                            Date_Of.text = "Label";
                            Date_Of.textFill = javafx.scene.paint.Color.BLACK;
                            lbladvanceamount.visible = false;
                            lbladvanceamount.layoutY = 0.0;
                            lbladvanceamount.text = "Label";
                            lbladvanceamount.textFill = javafx.scene.paint.Color.BLACK;
                            txtadvanceamount.visible = false;
                            txtadvanceamount.layoutY = 0.0;
                            txtadvanceamount.font = null;
                            panel.visible = false;
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            txtRefDoctorName.onKeyPressed = txtRefDoctorNameOnKeyPressed;
                            txtRefDoctorName.onKeyReleased = txtRefDoctorNameOnKeyReleasedAtShown;
                            txtRefDoctorName.editable = true;
                            txtDepartment.visible = false;
                            txtDepartment.layoutY = 220.0;
                            txtDepartment.onKeyPressed = txtDepartmentOnKeyPressedAtShown;
                            txtDepartment.onKeyReleased = txtDepartmentOnKeyReleasedAtShown;
                            ...
                            Date_Of.visible = false;
                            Date_Of.layoutY = 158.0;
                            Date_Of.text = "Date Of  Birth";
                            Date_Of.font = Arial_Bold_12;
                            Date_Of.textFill = DarkGray;
                            lbladvanceamount.visible = true;
                            lbladvanceamount.layoutY = 330.0;
                            lbladvanceamount.text = "Advance Amount";
                            lbladvanceamount.font = Arial_12;
                            lbladvanceamount.textFill = DarkGray;
                            txtadvanceamount.visible = true;
                            txtadvanceamount.layoutY = 330.0;
                            txtadvanceamount.font = Arial_12;
                            panel.visible = true;
    ...
    function txtDepartmentOnKeyReleasedAtShown(event: javafx.scene.input.KeyEvent): Void {
           getDepartment(1);
        if (event.code == KeyCode.VK_DOWN and listViewPatient.items != null) {
    ...
    function txtRefDoctorNameOnKeyReleasedAtShown(event: javafx.scene.input.KeyEvent): Void {
        getDoctor();
//        if (event.code == KeyCode.VK_DOWN) {
//            listViewPatient.requestFocus();
//            listViewPatient.selectFirstRow();
//        } else if (event.code == KeyCode.VK_ESCAPE or event.code == KeyCode.VK_TAB) {
//            listDocto.visible = false;
...
//        }
    ...
    public function getDepartment(con: Integer): Void {
        ...
        listViewPatient.layoutY = txtDepartment.layoutY + 22;
            ...
            var msg: String = "Class : PatientDetails  Method : getDepartment()  = {e.getMessage()}";
            log.debug(msg);
        }
    }
    ...
    public function getDoctor(): Void {
      try{
        ...
        listH = listControlObj.listImageControlView(txtRefDoctorName, listViewPatient, "doctor1", 1);
      ...
      txtRefDoctorName.requestFocus();
            ...
            var msg: String = "Class : PatientDetails  Method : getDoctor()  = {e.getMessage()}";
            log.debug(msg);
        }
   }
      ...
      try {
              ...
              if(i==false){
                if (san == 1) {
                    ...
                    System.out.println("praveeen");
                    customerModel.setRoomNumber(txtRoomNumber.rawText.trim().replaceAll("'", ""));
                   customerModel.setAdvanceamount(Double.parseDouble(txtadvanceamount.rawText.trim().replaceAll("'", "")));
    System.out.println("praveeen123");
        System.out.println(txtadvanceamount);
      ...
      try {
              ...
              if (san == 1) {
                ...
                var custType: String = null;
                 ...
                 customerModel.setWardNumber(txtWardNumber.rawText.trim().replaceAll("'", ""));
                 customerModel.setRoomNumber(txtRoomNumber.rawText.trim().replaceAll("'", ""));
               //  customerModel.setAdvanceamount(txtadvanceamount.rawText.trim().replaceAll("'", ""));
                 customerModel.setAdvanceamount(Double.parseDouble(txtadvanceamount.rawText.trim().replaceAll("'", "")));
                 customerModel.setCustType(custType);
                 customerModel.setAllergiesList(allergies);
                 customerModel.setHealthConditionsList(healthconditions);
    ...
    public function getPatient(con: Integer): Void {
       try{
        ...
        }if(listControlObj.selectedString!="")
        {
            ...
            var msg: String = "Class : PatientDetails  Method : getPatient()  = {e.getMessage()}";
            log.debug(msg);
        }
    }
