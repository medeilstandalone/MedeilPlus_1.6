...
public class Consultation {
   ...
   //sabarish def  Vital = VitalScienceModel{};
    ...
    var manageAppointmentTable = new ConsultationTable();
  ...
  //sabarish  var TableH = 160.0 on replace {
    ...
    public-read def label3: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C2LX+15
        text: "Label"
    }
    
    public-read def consultnot: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C1LX-44
        style: ""
        text: "Label"
    ...
    public-read def label5: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C3LX+25
        text: "Label"
    }
    
    public-read def lblHeight: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C4LX+70
        text: "Label"
    }
    
    public-read def lblRBS: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C4LX+225
        text: "Label"
    }
    ...
    public-read def panel: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        visible: true
        content: [ rectangle, rectangle2, label, rectTableBorder, panelTable, panelButton, labelSearch_By, labelSearch_By_Date, rdoDateSearch, label15, rdoPatientSearch, rdoDoctorSearch, label2, label3, consultnot, separator, label4, label5, lblHeight, lblRBS, name, date, labelsym, lblobservation, lblassem, lblplan, txtDoctorSearch, txtdate, txtBPsys, txtDpDia, txtHR, txtWeight, txtHeight, txtRBS, textsym, textobservation, txtassess, txtplan, panelSearch, panelDate, panelLblColumn1, panelTxtColumn1, panelLblColumn2, panelTxtColumn2, imageCustDown, imageDoctorDown, panelCalender, listName, panelAlert, ]
    }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            label2.text = "BP Systolic (mmHg)";
                            label2.font = Arial_14;
                            label2.textFill = DarkGray;
                            label3.visible = true;
                            label3.layoutY = 115.0;
                            label3.text = "BP Diastolic (mmHg)";
                            label3.font = Arial_14;
                            label3.textFill = DarkGray;
                            consultnot.visible = true;
                            consultnot.layoutY = 80.0;
                            consultnot.style = "";
                            consultnot.effect = reflectionEffect;
                            consultnot.text = "Consultation Notes";
                            consultnot.font = Arial_16;
                            consultnot.textFill = DarkGray;
                            ...
                            label5.visible = true;
                            label5.layoutY = 115.0;
                            label5.text = "Weight (kg)";
                            label5.font = Arial_14;
                            label5.textFill = DarkGray;
                            lblHeight.visible = true;
                            lblHeight.layoutY = 115.0;
                            lblHeight.text = "Height (M)";
                            lblHeight.font = Arial_14;
                            lblHeight.textFill = DarkGray;
                            lblRBS.visible = true;
                            lblRBS.layoutY = 115.0;
                            lblRBS.text = "RBS";
                            lblRBS.font = Arial_14;
                            ...
                            labelsym.layoutY = 140.0;
                            labelsym.text = "Symptom:";
                            ...
                            txtDpDia.layoutY = 115.0;
                            __layoutInfo_txtDpDia.width = 70.0;
                            __layoutInfo_txtDpDia.height = 21.0;
                            txtDpDia.editable = false;
                            txtHR.visible = true;
                            txtHR.layoutY = 115.0;
                            __layoutInfo_txtHR.width = 70.0;
                            __layoutInfo_txtHR.height = 21.0;
                            txtHR.editable = false;
                            txtWeight.visible = true;
                            txtWeight.layoutY = 115.0;
                            __layoutInfo_txtWeight.width = 70.0;
                            __layoutInfo_txtWeight.height = 21.0;
                            txtWeight.editable = false;
                            txtHeight.visible = true;
                            txtHeight.layoutY = 115.0;
                            __layoutInfo_txtHeight.width = 70.0;
                            __layoutInfo_txtHeight.height = 21.0;
                            txtHeight.editable = false;
                            txtRBS.visible = true;
                            txtRBS.layoutY = 115.0;
                            __layoutInfo_txtRBS.width = 70.0;
                            __layoutInfo_txtRBS.height = 21.0;
                            txtRBS.editable = false;
                            textsym.visible = true;
                            textsym.cursor = null;
                            textsym.layoutY = 160.0;
                            __layoutInfo_textsym.height = 50.0;
                            textsym.editable = false;
                            textsym.multiline = true;
                            textsym.lines = 8.0;
                            textobservation.visible = true;
                            textobservation.layoutY = 160.0;
                            __layoutInfo_textobservation.height = 50.0;
                            textobservation.editable = false;
                            textobservation.multiline = true;
                            textobservation.lines = 8.0;
                            txtassess.visible = true;
                            txtassess.layoutY = 240.0;
                            __layoutInfo_txtassess.height = 50.0;
                            txtassess.editable = false;
                            txtassess.multiline = true;
                            txtassess.lines = 8.0;
                            txtplan.visible = true;
                            txtplan.layoutY = 240.0;
                            __layoutInfo_txtplan.height = 50.0;
                            txtplan.editable = false;
  ...
  public function viewvital(name: String): Void {
      ...
      var height:String;
        ...
        try {
            ...
            pheight=VitalScienceModel.getpHeight();
            height=pheight.toString();
             ...
             txtdate.text=VitalScienceModel.getDate();
             txtHeight.text=height;
             txtRBS.text=VitalScienceModel.getvRBS();
    ...
    public function viewconsultation(name: String): Void {
       // java.lang.System.out.println("view consultation");  viewconsultationtable
     

        try {
            //java.lang.System.out.println("view vital1");

            consultationController = RegistryFactory.getClientStub("CustomerStub1") as Customer1;
           // java.lang.System.out.println("view vital2");
            var VitalScienceModel = consultationController.viewRecord2(name) as VitalScienceModel;
           // java.lang.System.out.println("view vital3");
            ...
            var msg: String = "Class : Customer Information  Method : viewconsultation()   = {e.getMessage()}";
            log.debug(msg);
        }
    }

     public function viewconsultationtable(name: String): Void {
      // java.lang.System.out.println("view viewconsultationtable");
        ...
        try {
            ...
            consultationController = RegistryFactory.getClientStub("CustomerStub1") as Customer1;
           // java.lang.System.out.println("view vital2");
            var Mhm1 = consultationController.viewRecord5(name) as ServiceModel;
      //  java.lang.System.out.println("view after");
            manageAppointmentTable.getTablevalue(Mhm1);

        } catch (e: Exception) {
            var msg: String = "Class : Customer Information  Method : viewconsultationtable()   = {e.getMessage()}";
            log.debug(msg);
        }
    }
    ...
    public function startUp(customerCode : String): Void {
       ...
       //sabarish txtDoctorSearch.style = mandatoryStyle;
        ...
        viewconsultationtable(customerCode);
    }
}