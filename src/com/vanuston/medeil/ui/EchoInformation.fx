                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lbl2AddNew.visible = true;
                            lbl2AddNew.layoutY = 65.0;
                            lbl2AddNew.text = "View All Echocardiography";
                            lbl2AddNew.font = Arial_18;
                            separator1.visible = true;
                            separator1.layoutX = 30.0;
                            separator1.layoutY = 90.0;
...
//    var panelButtonsLY = bind CommonDeclare.panelButtonsLY;
    ...
    var log: Logger = Logger.getLogger(EchoInformation.class, "EchoInformation");
    var style = {
                "-fx-border-radius: 30;"
            }
    ...
    function FXalert(type: Integer): Void {
        CustomAlert.ShowAlert("Echocardiography Information", type);
        showAlertbox();
    }
    ...
    function FXinfo(msg: String): Void {
        CustomAlert.ShowInfo("Echocardiography Information", msg);
        showAlertbox();
    }
    ...
    function txtPatientNameOnKeyReleased(event: javafx.scene.input.KeyEvent): Void {
        ...
        if (checkEditReguest) {
            radioViewTable.searchDicomInfoForEdit(txtPatientName.rawText.trim(), 6);
    ...
    public function getPatientOrDoctorList(): Void {
        ...
        radioViewTable.searchDicomInfo(txtPatientName.rawText.trim(), 4);

    }

    public function getPatientOrDoctorListForView(): Void {

        viewAllFileTable.searchDicomInfoForView(txtPatientName.rawText.trim(), 4);
    ...
    function actionForViewAllFunction(): Void {
        ...
        btnPanel.content = [btnPatientReport, btnPatientReset, btnPatientEdit, btnPatientSave, btnPatientCancel];
    ...
    function onActionForGenerateReport(): Void {
        ...
        try {
            ...
            if (viewAllFileTable.dicomSetId != -1) {
                ...
                var reportSource: File = new File("printerfiles/echo.jasper");
                var jasperReport: JasperReport = JRLoader.loadObject(reportSource) as JasperReport;
                var jasperPrint: JasperPrint = dicomImPController.jasperPrint(viewAllFileTable.dicomSetId, 1, jasperReport);
               // System.out.println(jasperPrint.toString());
                try {
                    JasperPrintManager.printReport(jasperPrint, false);
                    FXinfo("The Echo report has been printed sucessfully");
                } catch (ex: PrinterException) {
                     FXinfo("The Echo report has been  not printed sucessfully");
                    var que: String = "Class : EchoInformation  Method : onActionForGenerateReport()   = {ex.getMessage()}";
                    log.debug(que);
                    ex.printStackTrace();
                }
            } else {
    ...
    function getFullDetails(): Void {
        ...
        try {
            ...
            var que: String = "Class : EchoInformation  Method : getFullDetails()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function selectItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : EchoInformation  Method : selectItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function edit(): Void {
        ...
        try {
            ...
            var que: String = "Class : EchoInformation  Method : edit()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function setTableLay(): Void {
        ...
        radioViewTable.loadRadioInformatio(4);
        txtPatientName.requestFocus();
    ...
    public function displayItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : EchoInformation  Method : displayItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function select(): Void {
        ...
        try {
            ...
            var que: String = "Class : EchoInformation  Method : select()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function reportGenerate(): Void {
        ...
        try {
            ...
            var que: String = "Class : EchoInformation  Method : reportGenerate()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayReport(num: Integer): Void {
        try {
            ...
            var sqlDates: Date = getTodayDate();
            var viewDcmFile = new ViewDicomFiles();
            viewDcmFile.openReportDialogBox(dcmModel, 4, sqlDates);
            System.out.println("Success");
        } catch (ex: Exception) {
            var que: String = "Class : EchoInformation  Method : displayReport()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayItemForView(num: Integer): Void {
        try {
            ...
            var que: String = "Class : EchoInformation  Method : displayItemForView()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function cancel(): Void {
        try {
            ...
            var que: String = "Class : EchoInformation  Method : cancel()   = {ex.getMessage()}";
            log.debug(que);
        }
    }
