...
import com.vanuston.medeil.ui.calendar.view.FXCalendar;//padmini
import com.vanuston.medeil.ui.calendar.theme.Theme;//padmini
...
public class CustomerInformation {
    ...
    def edition = commonController.getProductType();
    ...
    public-read def imageDOB: javafx.scene.image.ImageView = javafx.scene.image.ImageView {
        visible: false
        layoutX: bind C4LX+93
        layoutY: 158.0
    }
    
    public-read def PatCalendarPanel: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        visible: false
        layoutX: bind C4LX+95
    }
    
    public-read def intime: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: true
        layoutX: bind C3LX
        layoutY: 215.0
        text: "InTime"
    ...
    def __layoutInfo_txtintime: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type3TextboxW
    }
    public-read def txtintime: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C4LX
        layoutY: 215.0
        layoutInfo: __layoutInfo_txtintime
        promptText: "yyyy/MM/dd HH:mm:ss"
    }
    
    public-read def buttonTime: javafx.scene.control.Button = javafx.scene.control.Button {
        layoutX: bind C4LX+180
        layoutY: 200.0
        text: "InTime"
    }
    
    def __layoutInfo_txtoccupation: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type1TextboxW
    }
    public-read def txtoccupation: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: true
        layoutX: bind C2LX
        layoutY: 213.0
        layoutInfo: __layoutInfo_txtoccupation
    }
    ...
    public-read def txtDateOfBirth: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: true
        layoutX: bind C4LX
        layoutY: 158.0
        font: Arial_12
    ...
    public-read def rdoCustTransgender: javafx.scene.control.RadioButton = javafx.scene.control.RadioButton {
        layoutX: bind C4LX+120
        layoutY: 130.0
        onKeyPressed: rdoCustTransgenderOnKeyPressed
        effect: null
        text: "Transgender"
        font: Arial_12
    ...
    public-read def occupation: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: true
        layoutX: bind C1LX
        layoutY: 213.0
        text: "Occupation"
    ...
    public-read def dateofbirth: javafx.scene.control.Label = javafx.scene.control.Label {
        layoutX: bind C3LX
        layoutY: 158.0
        text: "Date Of  Birth"
        textFill: DarkGray
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            rectPatientDetails.disable = false;
                            ...
                            lblPatientDetails.disable = false;
                            lblPatientDetails.layoutY = 457.0;
                            lblPatientDetails.text = "Additional Details";
                            ...
                            rdoCustTransgender.onMouseClicked = rdoCustTransgenderOnMouseClickedAtShown;
                            rdoCustTransgender.font = Arial_12;
                            rdoCustTransgender.toggleGroup = toggleGroup;
                            rdoCustTransgender.selected = false;
                            txtCustAge.layoutY = 185.0;
                            txtCustAdd2.promptText = "Area/Location";
                            optCustAlert.visible = false;
                            __layoutInfo_separator2.height = 5.0;
                            label16.layoutY = 236.0;
                            chkSendCustID.visible = false;
                            ...
                            dateofbirth.font = null;
                            txtDateOfBirth.visible = true;
                            txtDateOfBirth.onKeyPressed = txtDateOfBirthOnKeyPressedAtShown;
                            txtDateOfBirth.promptText = "dd-mm-yyyy";
                            txtDateOfBirth.editable = true;
                            txtDateOfBirth.font = Arial_12;
                            imageDOB.visible = true;
                            imageDOB.layoutY = 158.0;
                            ...
                            PatCalendarPanel.visible = true;
                            PatCalendarPanel.blocksMouse = true;
                            intime.visible = false;
                            intime.layoutY = 215.0;
                            intime.text = "InTime";
                            txtintime.visible = false;
                            txtintime.layoutY = 215.0;
                            txtintime.onKeyPressed = txtintimeOnKeyPressedAtShown;
                            buttonTime.visible = false;
                            buttonTime.onMouseClicked = buttonTimeOnMouseClickedAtShown;
                            occupation.visible = false;
                            occupation.layoutY = 213.0;
                            occupation.text = "Occupation";
                            occupation.font = Arial_12;
                            occupation.textFill = DarkGray;
                            txtoccupation.visible = false;
                            txtoccupation.disable = false;
                            txtoccupation.layoutY = 213.0;
                            txtoccupation.onKeyPressed = txtoccupationOnKeyPressedAtShown;
                        }
                    }
                ]
            }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            label.text = "Customer Details - Alt+C";
                            __layoutInfo_separator.height = 0.0;
                            label14.text = "Customer Code";
                            ...
                            label8.font = Arial_12;
                            labelCustomerType.visible = false;
                            labelCustomerType.text = "Customer Type";
                            labelCustomerType.textFill = javafx.scene.paint.Color.BLACK;
                            cboCustomerType.visible = false;
                            lblCreditLimit.visible = true;
                            lblCreditLimit.layoutY = 186.0;
                            lblCreditLimit.text = "Credit Limit";
                            discPrec.visible = false;
                            discPrec.layoutY = 216.0;
                            discPrec.text = "Discount (%)";
                            discPrec.font = Arial_12;
                            discPrec.textFill = DarkGray;
                            ...
                            rdoCustMale.selected = false;
                            rdoCustFemale.onMouseClicked = rdoCustFemaleOnMouseClickedAtShown;
                            rdoCustTransgender.onMouseClicked = rdoCustTransgenderOnMouseClickedAtFromSales;
                            rdoCustTransgender.font = Arial_12;
                            rdoCustTransgender.toggleGroup = toggleGroup;
                            rdoCustTransgender.selected = false;
                            txtCustAge.layoutY = 185.0;
                            txtCustAdd2.promptText = null;
                            optCustAlert.visible = true;
                            ...
                            txtDateOfBirth.visible = true;
                            txtDateOfBirth.promptText = null;
                            txtDateOfBirth.editable = true;
                            txtDateOfBirth.font = Arial_12;
                            imageDOB.visible = true;
                            imageDOB.layoutY = 158.0;
                            imageDOB.blocksMouse = false;
                            imageDOB.image = null;
                            PatCalendarPanel.visible = true;
                            PatCalendarPanel.blocksMouse = true;
                            intime.visible = true;
    ...
    function txtoccupationOnKeyPressedAtShown(event: javafx.scene.input.KeyEvent): Void {
        //TODOpadmini
        if (event.code == KeyCode.VK_ENTER or event.code == KeyCode.VK_TAB) {  }
        shortcut(event)
         }

    function txtintimeOnKeyPressedAtShown(event: javafx.scene.input.KeyEvent): Void {
        //TODOpadmini
        if (event.code == KeyCode.VK_ENTER or event.code == KeyCode.VK_TAB) { txtCustAdd1.requestFocus(); }
        shortcut(event);
         }

    function txtDateOfBirthOnKeyPressedAtShown(event: javafx.scene.input.KeyEvent): Void {
        //TODO  padmini
        txtDateOfBirth.style = mandatoryStyle;
        listViewCustomer.visible = false;
        if (event.code == KeyCode.VK_ENTER or event.code == KeyCode.VK_TAB) { txtCustAge.requestFocus(); }
        shortcut(event);
         }

    function buttonTimeOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
        //TODOpadmini
        curTimers();
         }
         public function curTimers():Void
         {
            var commDao=new CommonDAO();
            var dateTime:String=commDao.dateTime();
            txtintime.text="{dateTime}";
         }
    ...
    if (not dobFlag) {
       //  java.lang.System.out.println("Inside if not dobflag {dobFlag} " );
        PatCalendarPanel.layoutY = imageDOB.layoutY + txtDateOfBirth.height + 5.0;
        if (txtDateOfBirth.text != null) {
           //  java.lang.System.out.println("Inside if if");
            var dat = txtDateOfBirth.rawText.split("-");
            var d = Integer.parseInt(dat[0]);
            var m = Integer.parseInt(dat[1]) - 1;
            var y = Integer.parseInt(dat[2]);
           fxCalendar.set(y, m, d);
           //fxCalendar.set(d, m, y);
        } else {
            // java.lang.System.out.println("Inside else");
       ...
       // java.lang.System.out.println("Inside else else");
...
{
    if(i==1){
        txtDateOfBirth.text = fxCalendar.getSelectedDate();
        dobFlag = false;
        var s:String[] = txtDateOfBirth.text.split("-");
        var c:String[] = DateUtils.now("dd-MM-yyyy").split("-");
        txtCustAge.text = "{Integer.parseInt(c[2])- Integer.parseInt(s[2])}";
        txtCustAge.requestFocus();
    }
 }

    function rdoCustTransgenderOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
        //TODO padmini
         rdoCustMale.selected = false;
 ...
 function rectPatientDetailsOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
    ...
    var rectbuttonLY = bind CommonDeclare.rectbuttonLY;
     var CalendarLX = bind (32.02033037 * panelW) / 100;//padmini
     var ImageCalenderLX = bind C4LX + Type3TextboxW + 2;//padmini
    var listW = Type2TextboxW;
    var panelAlertLX = bind (panelW - 500) / 2;
    var panelAlertLY = bind (panelH - 150) / 2;
     //var C4LX+95 = bind (32.02033037 * panelW) / 100;
    ...
    function rdoCustMaleOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
     ...
     function rdoCustTransgenderOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
        //TODO padmini
       
            rdoCustTransgender.selected = true;
            rdoCustMale.selected = false;
            rdoCustFemale.selected = false;
            txtCustAge.requestFocus();
    ...
    function rdoCustMaleOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
       ...
       txtDateOfBirth.requestFocus();
        ...
        function rdoCustTransgenderOnMouseClickedAtFromSales(event: javafx.scene.input.MouseEvent): Void {
        //TODO padmini
         rdoCustMale.selected = false;
          rdoCustFemale.selected = false;
        //txtCustAge.requestFocus();
    ...
    public function save(chk: Integer): Integer {
        ...
        var cust = 0;
        try {
var cusnamemob :String= "{txtCustName.rawText} - {txtCustMobile.rawText.trim()}";
 System.out.println(cusnamemob);
            commonController = RegistryFactory.getClientStub(RegistryConstants.CommonImplements) as CommonImplements;
            var i: Integer = commonController.selectCount("cust_information", cusnamemob);
            if (i == 0) {
                var san: Integer = 0;
                san = clickValid(chk);
                if (san == 10) {
                    ...
                    if (rdoCustMale.selected == true) {
                        ...
                        gender = "Female";
                          } else if (rdoCustTransgender.selected == true) {
                        gender = "Transgender";
                    } else {
                        gender = "None";
                    }
                   ...
                   // java.lang.System.out.println("before model");
                    def customerModel: CustomerModel = new CustomerModel();
                   // java.lang.System.out.println("after model");
                    customerModel.setCustomerCode(txtCustCCode.rawText.trim());
                    customerModel.setCusttypeid("4");
                    customerModel.setFamilyName(txtCustFName.rawText.trim());
                    customerModel.setCustomerName(txtCustName.rawText.trim());
                    customerModel.setAge(txtCustAge.rawText);
                    customerModel.setGender(gender);
//                  customerModel.setDateofbirth(txtDateOfBirth.rawText.trim());
                    customerModel.setDateofbirth(DateUtils.changeFormatDate(sdf.parse(txtDateOfBirth.text)));
                   // customerModel.setOccupation(txtoccupation.rawText.trim());
                   // customerModel.setIntime(txtintime.rawText.trim());
                   // customerModel.setIntime(txtintime.rawText.replaceAll("'",""));
                    customerModel.setAddress1(txtCustAdd1.rawText.trim());
                    customerModel.setAddress2(txtCustAdd2.rawText.trim());
                    customerModel.setAddress3(txtCustAdd3.rawText.trim());
                    customerModel.setCity(txtCustCity.rawText.trim());
                    customerModel.setCountry(txtCustCountry.rawText.trim());
                    customerModel.setState(txtCustState.rawText.trim());
                    customerModel.setPincode(txtCustPincode.rawText.trim());
                    customerModel.setPhoneNumber(txtCustPhone.rawText.trim());
                    customerModel.setMobileNumber(txtCustMobile.rawText.trim());
                    customerModel.setEmailid(txtCustEmail.rawText.trim());
                    customerModel.setAlertType(optCustAlert.selectedItem.toString());
                    customerModel.setPatientType(0);
                  /* if (txtCreditLimit.rawText.trim() != "") {
                    ...
                    customerModel.setCreditLimit(0.00);
                    customerModel.setCreatedHspCode('H');
                    customerModel.setUpdatedHspCode('');
    ...
    public function update(): Void {
        ...
        try {
            ...
            if (san == 10) {
                ...
                customerModel.setAge(txtCustAge.rawText.trim());
                customerModel.setGender(gender);
                customerModel.setDateofbirth(DateUtils.changeFormatDate(sdf.parse(txtDateOfBirth.text)));
                //customerModel.setIntime(txtintime.rawText.trim());
              //  customerModel.setIntime(txtintime.rawText.replaceAll("'",""));
              //  customerModel.setOccupation(txtoccupation.rawText.trim());
                ...
                customerModel.setMobileNumber(txtCustMobile.rawText.trim());
                customerModel.setEmailid(txtCustEmail.rawText.trim());
                customerModel.setUpdatedHspCode('H');
                customerModel.setPatientType(0);
                if (txtCreditLimit.rawText.trim() != "") {
                    customerModel.setCreditLimit(Double.parseDouble(txtCreditLimit.rawText.trim()));
                } else {
                    customerModel.setCreditLimit(0.00);
                }
                var alert = optCustAlert.selectedItem.toString();
    ...
    public function getCust(con: Integer): Void {
        ...
        var selectString = bind listControlObj.selectedString on replace {
            ...
            var que = " Class : CustomerInformation   Method: getCust() )    Exception : {ex}";
            log.debug(que);
        }
    }
...
//        }
    ...
    public function getState(con: Integer) {
       ...
       try{
        ...
        var selS = bind listControlObj.selectedString on replace {
            ...
            var msg: String = "Class : CustomerInformation  Method : getState()   = {e.getMessage()}";
            log.debug(msg);
        }
    }
    ...
    public function getCountry(con: Integer) {
        ...
        var selS = bind listControlObj.selectedString on replace {
            ...
            var msg: String = "Class : CustomerInformation  Method : getCountry()   = {e.getMessage()}";
            log.debug(msg);
        }
    }
...
//            var custDiscType = commonController.CustomerType().toArray();
    ...
    public function custCode(): String {
        ...
        finalCode = commonController.getCustId("cust_information", "cust_code", "UHID");
    }
...
//            txtoccupation.text = customerModel.getOccupation();
    ...
    public function clickValid(ch: Integer): Integer {
        ...
        var inti =txtintime.rawText.replaceAll("'", "");
        ...
        var credit = txtCreditLimit.rawText;
         var fname = txtCustFName.rawText.replaceAll("'", "");
        var cnt: Integer = 0;
...
//            else if (inti.length() <=0) {
//                FXinfo("Please Enter Intime.");
//            }
...
//            } 
                ...
                FXinfo("Please select the Patient Type."); cboCustomerType.requestFocus();
            }
//            else if (aheno < 1) {
...
//            }
            ...
            } else if (mobile.equals("") or mobile.length() < 10) {
    ...
    function mandatory(): Void {
        ...
        txtDateOfBirth.style = mandatoryStyle;
        txtCustAdd1.style = mandatoryStyle;
        txtintime.style = mandatoryStyle;
    ...
    public function getPrivileges(u: String): Void {
        ...
        if (utype.equals("User")) {
            def priv = commonController.getPrivileges("masters", uname);
            def ss = priv.split(",");
            def val = Integer.parseInt(ss[2]);
            if (val == 1) {
    ...
    def changPiv = bind btnCustSave.text on replace {
        getPrivileges(logUser);
    }
    def changPiv1 = bind btnCustEdit.text on replace {
        getPrivileges(logUser);
    }
    ...
    public function StartUp(): Void {
        ...
        optCustAlert.select(0);
        reset();
        panel.content = [rectangle, rectHeader, label, separator, label14, label2, label3, label4, label5, label6, label7, label8, label9, label10, label11, label12, label13, lblCreditLimit, panelButtons, txtCustName, txtCustCCode, txtCustFName, txtCreditLimit, rdoCustMale, rdoCustFemale,rdoCustTransgender,txtDateOfBirth,dateofbirth,imageDOB,txtCustAge, txtCustAdd1, txtCustAdd2, txtCustCity, txtCustPhone, txtCustEmail, txtCustPincode, txtCustCountry, txtCustState, optCustAlert, txtCustAdd3, separator2, label15, label16, label1, txtCustMobile, chkSendCustID, panelMsgBox, imageCustDown, imageCountryDown, imageStateDown,txtoccupation, cboCustomerType,  labelCustomerType, txtDiscountPer , discPrec,rectPatientDetails,lblPatientDetails,listViewCustomer, panelAlert,occupation,intime,txtintime,buttonTime,PatCalendarPanel,];
        txtCustCCode.editable = false;
        fxCalendar.visible = false;
          PatCalendarPanel.content = [fxCalendar,];
        imageDOB.image=Image {url: "{__DIR__}images/Calender.png"};
        txtCustCCode.requestFocus();
        mandatory();
        srCode = custCode();
        ...
        if(edition.equals("Free") or edition.equals("Lite")){
            rectPatientDetails.disable = true;
            lblPatientDetails.disable = true;
        }
        getPrivileges(logUser);
        txtCustName.requestFocus();
       // txtintime.style=manetory;
    }
