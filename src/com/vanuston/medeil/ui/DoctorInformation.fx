...
public class DoctorInformation {
    ...
    def __layoutInfo_txtDoctorRoomNo: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type1TextboxW-200
    }
    public-read def txtDoctorRoomNo: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C4LX
        layoutInfo: __layoutInfo_txtDoctorRoomNo
    }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            label.layoutX = 0.0;
                            label.layoutY = 1.0;
                            label.text = "Doctor Details - Alt+O";
                            label.hpos = javafx.geometry.HPos.CENTER;
                            separator.layoutY = 80.0;
                            __layoutInfo_separator.height = 5.0;
                            label4.text = "Address ";
                            label8.text = "Doctor  Name";
                            label18.visible = true;
                            label18.layoutY = 186.0;
                            label18.text = "Doctor Room No";
                            ...
                            txtDoctorRoomNo.visible = true;
                            txtDoctorRoomNo.layoutY = 186.0;
                            txtDoctorRoomNo.font = Arial_12;
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            txtDoctorDName.onKeyPressed = txtDoctorDNameOnKeyPressedAtShown;
                            txtDoctorHName.onKeyPressed = txtDoctorHNameOnKeyPressedAtShown;
                            txtDoctorRoomNo.visible = false;
                            txtDoctorRoomNo.layoutY = 0.0;
                            txtDoctorAdd1.onKeyPressed = txtDoctorAdd1OnKeyPressedAtShown;
                            txtDoctorAdd2.onKeyPressed = txtDoctorAdd2OnKeyPressedAtShown;
                            txtDoctorAdd2.onKeyReleased = txtDoctorAdd2OnKeyReleasedAtShown;
                            txtDoctorCity.onKeyPressed = txtDoctorCityOnKeyPressedAtShown;
...
//        txtDoctorAdd3.requestFocus();
    ...
    function initial(): Void {
        try {
            ...
            doctorModel.setDoctorRoomNo(txtDoctorRoomNo.rawText.trim());
    ...
    function displayDoctor(code: String): Void {
        try {
            ...
            txtDoctorRoomNo.text = doctorModel1.getDoctorRoomNo();
...
//                }
    ...
    def changPiv =  bind btnDoctorEdit.text on replace{
            getPrivileges(logUser);
        }

    def changPiv1 =  bind btnDoctorSave.text on replace{
            getPrivileges(logUser);
        }		
    def kr = KeyRegistry {};
