...
//    public function Load_CTInfo(): Void {
//        deleteForm(5);
//        def CTInformation = CTInformation {};
//        CTInformation.Startup();
//        insert CTInformation.getDesignRootNodes() into panelMastersForm.content;
//    }
 public function Load_MriInfo(): Void {
        deleteForm(6);
        def MriInfo = MriInfo {};
        MriInfo.Startup();
    ...
    function rectMenu1OnMouseClickedAtSubMenu(event: javafx.scene.input.MouseEvent): Void {
        Load_XRayInformation();
    }

    public function Load_XRayInformation(): Void {
        deleteForm(1);
//        deleteForm(2);
    ...
    public function Load_UltraSound(): Void {
        deleteForm(2);
//        deleteForm(3);
