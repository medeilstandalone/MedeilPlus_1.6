...
public class Testname {
    ...
    var log: Logger = Logger.getLogger(Testname.class, "Utilities");
    public var formulation = "";
    def CustomAlert = CustomAlert {};
    // <editor-fold defaultstate="collapsed" desc="Generated Code">//GEN-BEGIN:main
    def __layoutInfo_txtmin: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: 250.0
    }
    public-read def txtmin: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        layoutX: 187.0
        layoutY: 90.0
        layoutInfo: __layoutInfo_txtmin
        onKeyPressed: txtminOnKeyPressed
    }
    ...
    def __layoutInfo_txtmax: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: 250.0
    }
    public-read def txtmax: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        layoutX: 187.0
        layoutY: 75.0
        layoutInfo: __layoutInfo_txtmax
        onKeyPressed: txtmaxOnKeyPressed
    }
    ...
    public-read def panelLicenceInfo: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        layoutX: 0.0
        layoutY: 30.0
        content: [ vbox, vbox6, vbox7, vbox8, vbox9, vbox10, vbox11, vbox1, vbox2, vbox3, vbox4, vbox5, hbox, hbox2, ]
    }
    ...
    function txtmaxOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
         if (event.code == KeyCode.VK_ENTER or event.code == KeyCode.VK_TAB) {
            button.requestFocus();
        }
         }

    function txtminOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
       if (event.code == KeyCode.VK_ENTER or event.code == KeyCode.VK_TAB) {
            txtmax.requestFocus();
        }
         }
    ...
    function FXinfo(msg: String): Void {
        CustomAlert.ShowInfo("Add Test Name", msg);
        showAlertbox();
    }
...
function saveformulation(): Void {
      ...
      //   var valObj: Validation = new Validation();
         var ms:String=textbox.rawText.trim();
         var m: Integer = textbox.rawText.length();

        // var amount : String =textbox.rawText.trim();
        //amountss = Double.parseDouble(amount);
        //var amountss: Double;
        
         var m2: String = txtFormulation.rawText.trim();//naziya
         var m3: Integer = txtFormulation.rawText.length();//naziya

         var min:String=txtmin.rawText.trim();//sabarish
//         var minvalue: Double;//sabarish
//         minvalue = Double.parseDouble(min);//sabarish

           var max:String=txtmax.rawText.trim();//sabarish
//         var maxvalue: Double;//sabarish
//         maxvalue = Double.parseDouble(max);//sabarish
        ...
        // java.lang.System.out.println("{m2}");
         ...
         if(m2==null and m2==""){
              FXinfo("Please Enter Test Name ");
         }else if(m3<=0){
              FXinfo("Please Enter Test Name ");
         }else if(min == "" and min == null){
              FXinfo("Please Enter Minimum Range ");
         }else if(max == "" and max == null){
              FXinfo("Please Enter Maximum Range ");
         }
         else{
