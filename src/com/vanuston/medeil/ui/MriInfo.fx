                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lbl2AddNew.visible = true;
                            lbl2AddNew.layoutY = 65.0;
                            lbl2AddNew.text = "View All Magnetic Resonance Imaging";
                            lbl2AddNew.font = Arial_18;
                            separator1.visible = true;
                            separator1.layoutX = 30.0;
                            separator1.layoutY = 90.0;
...
//
    ...
    var log: Logger = Logger.getLogger(MriInfo.class, "MriInfo");
    var style = {
                "-fx-border-width:2;"
    ...
    function FXalert(type: Integer): Void {
        CustomAlert.ShowAlert("Magnetic Resonance Imaging Information", type);
        showAlertbox();
    }
    ...
    function FXinfo(msg: String): Void {
        CustomAlert.ShowInfo("Magnetic Resonance Imaging Information", msg);
        showAlertbox();
    }
    ...
    public function getPatientOrDoctorList(): Void {
        ...
        radioViewTable.searchDicomInfo(txtPatientName.rawText.trim(), 6);

    }

    public function getPatientOrDoctorListForView(): Void {

        viewAllFileTable.searchDicomInfoForView(txtPatientName.rawText.trim(), 6);
    ...
    function onActionForGenerateReport(): Void {
        ...
        try {
            ...
            if (viewAllFileTable.dicomSetId != -1) {
                ...
                var reportSource: File = new File("printerfiles/mrireport.jasper");
                var jasperReport: JasperReport = JRLoader.loadObject(reportSource) as JasperReport;
                var jasperPrint: JasperPrint = dicomImPController.jasperPrint(viewAllFileTable.dicomSetId, 6, jasperReport);
               // System.out.println(jasperPrint.toString());
                try {
                    JasperPrintManager.printReport(jasperPrint, false);
                     FXinfo("The MRI report has been printed sucessfully");
                } catch (ex: PrinterException) {
                    FXinfo("The MRI report has been not printed sucessfully");
                    var que: String = "Class : MriInfo  Method : onActionForGenerateReport()   = {ex.getMessage()}";
                    log.debug(que);
                    ex.printStackTrace();
                }
            } else {
    ...
    function getFullDetails(): Void {
        ...
        try {
            ...
            var que: String = "Class : MriInfo  Method : getFullDetails()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function selectItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : MriInfo  Method : selectItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function edit(): Void {
        ...
        try {
            ...
            var que: String = "Class : MriInfo  Method : edit()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function setTableLay(): Void {
        ...
        radioViewTable.loadRadioInformatio(6);
        txtPatientName.requestFocus();
    ...
    public function displayItem(num: Integer): Void {
        try {
            ...
            var que: String = "Class : MriInfo  Method : displayItem()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function select(): Void {
        ...
        try {
            ...
            var que: String = "Class : MriInfo  Method : select()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    function reportGenerate(): Void {
        ...
        try {
            ...
            var que: String = "Class : MriInfo  Method : reportGenerate()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayReport(num: Integer): Void {
        try {
            ...
            var sqlDates: Date = getTodayDate();
            var viewDcmFile = new ViewDicomFiles();
            viewDcmFile.openReportDialogBox(dcmModel, 6, sqlDates);
            System.out.println("Success");
        } catch (ex: Exception) {
            var que: String = "Class : MriInfo  Method : displayReport()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function displayItemForView(num: Integer): Void {
        try {
            ...
            var que: String = "Class : MriInfo  Method : displayItemForView()   = {ex.getMessage()}";
            log.debug(que);
            ex.printStackTrace();
        }
    ...
    public function cancel(): Void {
        try {
            ...
            var que: String = "Class : MriInfo  Method : cancel()   = {ex.getMessage()}";
            log.debug(que);
        }
    }
