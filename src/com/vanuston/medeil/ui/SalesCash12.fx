...
var SalesFormTitle:String="Service Billing";//sabarish
var log: Logger = Logger.getLogger(SalesCash12.class,"SalesCash");
...
//                    }
    ...
    function Load(index:Integer): Void { //On the second form onwards        
        try {
            ...
            SalesFormTitle = "Service Bill-{n + 1} - ctrl+S";//sabarish
