...
//public class PatientDetails  {
   ...
   var log: Logger = Logger.getLogger(MedicalHistory.class, "PatientDetailsInfo");
    var listH = 0.0;
    ...
    public-read def imgCalendar: javafx.scene.image.ImageView = javafx.scene.image.ImageView {
        visible: false
        layoutX: bind C2LX-280+txtPatientDate.width
    }
    ...
    public-read def imagePatientList: javafx.scene.image.ImageView = javafx.scene.image.ImageView {
        visible: false
        layoutX: bind C2LX-280+Type1TextboxW-2
        layoutY: 267.0
    ...
    public-read def bloodgroupBG: javafx.scene.control.ChoiceBox = javafx.scene.control.ChoiceBox {
        visible: false
        layoutX: bind C2LX-280
        items: bind BG
    }
    
    public-read def texbloodgroup: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C2LX
    }
    ...
    def __layoutInfo_texg6pd: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type1TextboxW
    }
    public-read def texg6pd: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C2LX-280
        layoutInfo: __layoutInfo_texg6pd
    }
    
    public-read def smokinghistory: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C1LX-200
        text: "Label"
    }
    
    def __layoutInfo_texsmokinghistory: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type1TextboxW
    }
    public-read def texsmokinghistory: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C2LX-280
        layoutInfo: __layoutInfo_texsmokinghistory
    }
    
    public-read def medicinename: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C1LX-200
        text: "Label"
    }
    
    def __layoutInfo_texmedicinename: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type1TextboxW
    }
    public-read def texmedicinename: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C2LX-280
        layoutInfo: __layoutInfo_texmedicinename
    }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lblPatientDetails.text = "Medical History - Alt+C";
                            lblPatientDate.visible = false;
                            lblPatientDate.layoutY = 80.0;
                            ...
                            bloodgroup.layoutY = 0.0;
                            bloodgroup.text = "Label";
                            bloodgroup.textFill = javafx.scene.paint.Color.BLACK;
                            bloodgroupBG.visible = false;
                            bloodgroupBG.layoutY = 0.0;
                            texbloodgroup.visible = false;
                            texbloodgroup.layoutY = 0.0;
                            g6pd.visible = false;
                            g6pd.layoutY = 0.0;
                            g6pd.text = "Label";
                            g6pd.textFill = javafx.scene.paint.Color.BLACK;
                            texg6pd.visible = false;
                            texg6pd.layoutY = 0.0;
                            smokinghistory.visible = false;
                            smokinghistory.layoutY = 0.0;
                            smokinghistory.text = "Label";
                            smokinghistory.textFill = javafx.scene.paint.Color.BLACK;
                            texsmokinghistory.visible = false;
                            texsmokinghistory.layoutY = 0.0;
                            medicinename.visible = false;
                            medicinename.layoutY = 0.0;
                            medicinename.text = "Label";
                            medicinename.textFill = javafx.scene.paint.Color.BLACK;
                            texmedicinename.visible = false;
                            texmedicinename.layoutY = 0.0;
                            panel.visible = false;
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            lblPatientType.text = "Patient Type";
                            lblPatientName.layoutY = 130.0;
                            lblPatientName.text = "Patient Name";
                            lblRefDoctorName.visible = false;
                            ...
                            imagePatientList.layoutY = 130.0;
                            imagePatientList.onMouseClicked = imagePatientListOnMouseClicked;
                            ...
                            lblCustomerDetails.font = Arial_12;
                            ...
                            bloodgroup.layoutY = 165.0;
                            bloodgroup.text = "Blood Group";
                            bloodgroup.font = Arial_12;
                            bloodgroup.textFill = DarkGray;
                            bloodgroupBG.visible = true;
                            bloodgroupBG.layoutY = 165.0;
                            bloodgroupBG.onMouseClicked = bloodgroup2OnMouseClickedAtShown;
                            texbloodgroup.visible = false;
                            texbloodgroup.layoutY = 214.0;
                            g6pd.visible = true;
                            g6pd.layoutY = 200.0;
                            g6pd.text = "Diabetic";
                            g6pd.font = Arial_12;
                            g6pd.textFill = DarkGray;
                            texg6pd.visible = true;
                            texg6pd.layoutY = 200.0;
                            smokinghistory.visible = true;
                            smokinghistory.layoutY = 240.0;
                            smokinghistory.text = "Cardiac";
                            smokinghistory.font = Arial_12;
                            smokinghistory.textFill = DarkGray;
                            texsmokinghistory.visible = true;
                            texsmokinghistory.layoutY = 240.0;
                            texsmokinghistory.font = null;
                            medicinename.visible = true;
                            medicinename.layoutY = 275.0;
                            medicinename.text = "Medicine Name";
                            medicinename.font = Arial_12;
                            medicinename.textFill = DarkGray;
                            texmedicinename.visible = true;
                            texmedicinename.layoutY = 275.0;
                            panel.visible = true;
    ...
    function bloodgroup2OnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
        //TODOPADMINI
        BG = ["Select", "A +ve", "A -ve", "B +ve", "B -ve", "O +ve", "O -ve", "AB +ve", "AB -ve"];
    bloodgroupBG.select(0);
    bloodgroupBG.requestFocus()
         }
    ...
    public function del(): Void {
       try {
            if (txtPatientName.text != null) {
                ...
                if (a) {
                    //Controller Call
                    var isCreate:Boolean=patientDetailsController.deletePatientDetailsRecord(txtPatientName.rawText) as Boolean;
                    if(isCreate){
    ...
    public function getPatient(con: Integer): Void {
        ...
        if(btnSave.text=="Update [F7]"){
            ...
            if (selectString.length() > 0) {
                txtRefDoctorName.requestFocus();
                var patInfo:List = commonController.getQueryValue("select p.doctor_name,p.department,p.ward_number,p.room_number from cust_information c,med_patient_details_mt p where p.cust_code=c.cust_code and p.cust_name='{selectString}' or c.cust_code='{selectString}' or c.mobile_no='{selectString}' and p.is_active=1 and c.cust_flag_id=0",4);
