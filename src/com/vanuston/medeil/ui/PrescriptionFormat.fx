...
import com.vanuston.medeil.uitables.PrescriptionHistory;
import java.lang.System;
import com.vanuston.medeil.uitables.Radiology;
...
public class PrescriptionFormat {
    ...
    def __layoutInfo_txtDose: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
        width: bind Type4TextboxW+100
    }
    public-read def txtDose: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind C3LX+120
        layoutY: 145.0
        layoutInfo: __layoutInfo_txtDose
    }
    ...
    public-read def labelnote: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind C3LX+430
        text: "Label"
    }
    ...
    def __layoutInfo_btnPrevPres: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
    }
    public-read def btnPrevPres: javafx.scene.control.Button = javafx.scene.control.Button {
        visible: false
        layoutX: bind fifthCol4-50
        layoutInfo: __layoutInfo_btnPrevPres
        text: "Button"
    }
    
    public-read def lblpid: javafx.scene.control.Label = javafx.scene.control.Label {
        visible: false
        layoutX: bind lblpid.layoutY + lblpid.width +450
        text: "Label"
    }
    ...
    public-read def txtPid: javafx.scene.control.TextBox = javafx.scene.control.TextBox {
        visible: false
        layoutX: bind lblpid.layoutX + lblpid.width + 10
        layoutInfo: __layoutInfo_txtPid
    }
    
    def __layoutInfo_btnPrepathis: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
    }
    public-read def btnPrepathis: javafx.scene.control.Button = javafx.scene.control.Button {
        visible: false
        layoutX: bind fifthCol4-250
        layoutInfo: __layoutInfo_btnPrepathis
        text: "Button"
    }
    
    def __layoutInfo_Radiology: javafx.scene.layout.LayoutInfo = javafx.scene.layout.LayoutInfo {
    }
    public-read def Radiology: javafx.scene.control.Button = javafx.scene.control.Button {
        visible: false
        layoutX: bind fifthCol4-250
        layoutInfo: __layoutInfo_Radiology
        text: "Button"
    }
    ...
    public-read def panelTxtColumn1: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        visible: false
        layoutY: 31.0
        content: [ txtRemarks, txtFee, txtNextVisit, lblRemarks, lblNextVisit, lblFee, btnFood, imgCalendar, lblnote, ]
    }
                ...
                keyFrames: [
                    javafx.animation.KeyFrame {
                        ...
                        action: function() {
                            ...
                            txtPatientName.promptText = "Patient name or MobileNo or Patient UHID(UHID0000001)";
                            ...
                            txtDoctorName.text = "";
                            txtDoctorName.promptText = "Enter Doctor Name";
                            ...
                            __layoutInfo_txtDose.height = 30.0;
                            txtDose.onKeyPressed = txtDoseOnKeyPressedAtShown;
                            txtDose.multiline = true;
                            txtQty.visible = true;
                            ...
                            labelnote.layoutY = 220.0;
                            labelnote.text = "Note : Please Click Enter";
                            labelnote.font = Arial_Bold_12;
                            labelnote.textFill = Red;
                            ...
                            btnpatienttest.layoutY = 110.0;
                            __layoutInfo_btnpatienttest.width = 143.0;
                            ...
                            btnPrevPres.visible = true;
                            btnPrevPres.layoutY = 65.0;
                            __layoutInfo_btnPrevPres.width = 143.0;
                            __layoutInfo_btnPrevPres.height = 30.0;
                            btnPrevPres.text = "Previous Prescription";
                            btnPrevPres.font = Arial_Bold_12;
                            btnPrevPres.action = btnPrevPresActionAtShown;
                            lblpid.visible = false;
                            lblpid.layoutY = 100.0;
                            lblpid.text = "Presid";
                            lblpid.font = Arial_12;
                            lblpid.textFill = DarkGray;
                            txtPid.visible = false;
                            txtPid.layoutY = 100.0;
                            txtPid.font = Arial_12;
                            btnPrepathis.visible = true;
                            btnPrepathis.layoutY = 90.0;
                            __layoutInfo_btnPrepathis.width = 158.0;
                            __layoutInfo_btnPrepathis.height = 30.0;
                            btnPrepathis.onMouseClicked = btnPrepathisOnMouseClickedAtShown;
                            btnPrepathis.text = "Previous Patient History";
                            btnPrepathis.font = Arial_Bold_12;
                            Radiology.visible = true;
                            Radiology.layoutY = 50.0;
                            __layoutInfo_Radiology.width = 158.0;
                            __layoutInfo_Radiology.height = 30.0;
                            Radiology.onMouseClicked = RadiologyOnMouseClickedAtShown;
                            Radiology.text = "Radiology";
                            Radiology.font = Arial_Bold_12;
                            ...
                            lblnote.layoutY = 60.0;
                            lblnote.text = "Note : To save prescription please enter vital information.";
                            lblnote.font = Arial_Bold_14;
...
function btnPrepathisOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
         //System.out.println("patienthistory");
        patienthistory("customername");
         }
         
 function checkValid1(): Integer {
       ...
       else if((txtAge.rawText.trim().equals(""))) {
...
function RadiologyOnMouseClickedAtShown(event: javafx.scene.input.MouseEvent): Void {
       if(checkValid1()==0){
       var jTableInstance: javax.swing.JTable ;
        radiology=new Radiology(jTableInstance,"d");
        var gender;
         if(rdoMale.selected==false )
         {
             gender="Female";
             }
             else
    ...
    var rad=[txtPrescDate.rawText.trim(),txtDoctorName.rawText.trim(),txtPatientName.rawText.trim(),txtAge.rawText.trim(),gender];
    System.out.println(rad);
    radiology.setTablevalues(rad);
        radiology.setVisible(true);
        }
         }


    function btnPrevPresActionAtShown(): Void {
    ...
    function drugSpecification(foodInteraction:String):Void {
     ...
     function patienthistory(customername:String):Void {
      //  System.out.println("patienthistory1");
        var jTableInstance: javax.swing.JTable ;
        ph = new PrescriptionHistory(jTableInstance, customername);
        ph.loadfirstValues(txtPatientName.rawText.trim());
     //   System.out.println("patienthistory2");
        ph.setVisible(true);
      }
    ...
    function getDoctorList(): Void {
        ...
        var selS: String = bind listControlObj.selectedString on replace {
            ...
            var msg: String = "Class : PrescriptionFormat  Method : getDoctorList()  = {e.getMessage()}";
            log.debug(msg);
        }
    }
...
//     var salesController : Prescription = RegistryFactory.getClientStub(RegistryConstants.Prescription) as Prescription;
    public function savePrescription(ss: Integer): Void {
       // java.lang.System.out.println("save button");
        try {
                ...
                var nextVisit = "";
                if(txtNextVisit.rawText != "" or txtNextVisit.rawText!=null){
                 nextVisit= DateUtils.changeFormatDate(sdf.parse(txtNextVisit.rawText));
                }
                ...
                prescriptionModel.setAppoinmentid(Integer.parseInt(pid));
                ...
                if(nextVisit.equals("") or nextVisit == null)
                {
                    prescriptionModel.setNextVisit("0000-00-00");
                }
                else {
                    prescriptionModel.setNextVisit(nextVisit);
                }
                //java.lang.System.out.println("pf ui: next visit: {nextVisit}");
                ...
                {                       
                    ...
                    if (ss == 1) {
                        ...
                        type = "Print";
                       // java.lang.System.out.println("inside print");
                        var reportSource: File = new File("printerfiles/PrescriptionPrint.jasper");
                       // java.lang.System.out.println("after logine print");
                        var jasperReport:JasperReport =  JRLoader.loadObject(reportSource) as JasperReport;
                        var jasperPrint:JasperPrint = commonController.jasperPrint(prescNo, "Prescription",jasperReport);
                       // java.lang.System.out.println("after logine print2");
                        JasperPrintManager.printReport(jasperPrint, false);
                       // java.lang.System.out.println("after logine print3");
                    }
                    FXalert(0);
                    backKeypressed();

                }
               // java.lang.System.out.println("try ui save ");
            }
        } catch (ex: Exception) {
            //java.lang.System.out.println("catch ui: {ex}");
...
listH = listControlObj.listImageControlView(txtPatientName, listPatientName, "prctCustomer1", 1);
        //listH = listControlObj.listImageControlView(txtPatientName, listPatientName, "prctCustomer", 1);
         if (btnSaveOnly.text.equals("Update [F7]")) {
...
//            listH = listControlObj.listImageControlView(txtPatientName, listPatientName, "prctCustomer1", 1);
         ...
         if (listPatientName.selectedItem != "New name...") {
           ...
           var customerDetails:List = commonController.getQueryValue("select c.age as age ,c.gender as gender ,a.id as appid from medp_appointment_mt a INNER JOIN cust_information c on c.cusname_mobno=a.patient_name  where a.app_status=1 and  c.cusname_mobno='{txtPatientName.rawText.trim()}' ORDER BY a.id desc", 2) ;
          var customerDetails2:List = commonController.getQueryValue("select a.id as appid from medp_appointment_mt a INNER JOIN cust_information c on c.cusname_mobno=a.patient_name  where a.app_status=1 and  c.cusname_mobno='{txtPatientName.rawText.trim()}' ORDER BY a.id desc", 2) ;
                   System.out.println(customerDetails2);
           System.out.println("customerDetails");
             System.out.println(customerDetails);
           txtAge.text = customerDetails.get(0).toString();
             txtPid.text = customerDetails2.get(0).toString();
...
//          println("curPrescriptionDate {curPrescriptionDate} followupDateLimit  {new SimpleDateFormat("yyyy-MM-dd").parse(followupDateLimit)}");
         ...
         if (listPatientName.selectedItem != "New name...") {
           ...
           //var customerDetails:List = commonController.getQueryValue("select age,gender from cust_information where concat(cust_name,' - ',mobile_no)='{txtPatientName.rawText.trim()}'", 2);
           var customerDetails:List = commonController.getQueryValue("select c.age as age ,c.gender as gender ,a.id as appid from medp_appointment_mt a INNER JOIN cust_information c on c.cusname_mobno=a.patient_name  where a.app_status=0 and c.cusname_mobno='{txtPatientName.rawText.trim()}' ORDER BY a.id desc", 2) ;
          var customerDetails2:List = commonController.getQueryValue("select a.id as appid from medp_appointment_mt a INNER JOIN cust_information c on c.cusname_mobno=a.patient_name  where a.app_status=0 and c.cusname_mobno='{txtPatientName.rawText.trim()}' ORDER BY a.id desc", 2) ;
           txtAge.text = customerDetails.get(0).toString();
             txtPid.text = customerDetails2.get(0).toString();
            if(customerDetails.get(1).toString().equalsIgnoreCase("Male")) {
                rdoMale.selected = true;
...
//          println("curPrescriptionDate {curPrescriptionDate} followupDateLimit  {new SimpleDateFormat("yyyy-MM-dd").parse(followupDateLimit)}");
    ...
    function getPrivileges(u: String): Void {
        ...
        if (utype.equals("User")) {
            var priv = commonController.getPrivileges("practice", uname);
            var ss = priv.split(",");
