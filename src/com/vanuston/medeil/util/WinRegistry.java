...
//            actKey = userRoot.get("KeyA", defaultValue);
            actKey = systemRoot.get("MpsGSTKeyA", defaultValue);
            a.add(actKey);
//            licHold = userRoot.get("LicHold", defaultValue);
            licHold = systemRoot.get("MpsGSTLicHold", defaultValue);
            a.add(licHold);
//            appPath = userRoot.get("AppPath", defaultValue);
            appPath = systemRoot.get("MpsGSTAppPath", defaultValue);
            a.add(appPath);
            userRoot.flush();
            systemRoot.flush();
        } catch (Exception e) {
    ...
    public String getCustvalue() {
        try {
            custName = userRoot.get("MpsGSTLicHold", defaultValue);
...
//                    Date CurDate = daFormt.parse(DateUtils.now("yyyy-MM-dd"));
    ...
    public String getInstalledDay() {
        String installDay = "";
        try {
            installDay = userRoot.get("MpsGSTinstalledday", defaultValue);
            installDay = systemRoot.get("MpsGSTinstalledday", defaultValue);
            installDay = userRoot.get("MpsGSTinstalledday", defaultValue);
            userRoot.flush();
            systemRoot.flush();
        } catch (Exception e) {
    ...
    public String getActKey() {
        ...
        try {
            ...
            custAct = systemRoot.get("MpsGSTKeyA", defaultValue);
            userRoot.flush();
            systemRoot.flush();
        } catch (Exception e) {
            String ss = "Method: getCustvalue    Exception : " + e.getMessage();
